...
function gameOver(a){
    let gameOverAlertElement = "<b>FIM DO JOGO </b><br><br> Jogador" + span[a].dataset.player.toUpperCase() + ' Ganhar !!! <br><br>' + restartButton
    div.className = "alert"
...
function draw(){
    let drawAlertElement = '<b>EMPATE!!!</b><br><br>' + restartButton
    div.className = alert
